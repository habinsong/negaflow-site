 ...
 * `heading` and `desc` name existing i18n keys. `sections` lists the section ids
...
const TOPICS = [
  {
    slug: 'chroma-engine',
    heading: { key: 'topic.chroma.title' },
  ...
  {
    slug: 'grainmend',
    heading: { key: 'topic.grainmend.title' },
    desc: { key: 'gm.lede' },
    sections: ['grainmend'],
    card: 'grainmend.jpg'
  },
  ...
  {
    slug: 'download',
    heading: { key: 'topic.download.title' },
    desc: { key: 'dl.body' },
    sections: ['download'],
    card: 'download.jpg'
  }
...
function buildPage(lang, template, dict, version, topic) {
  ...
  if (topic) {
    ...
    html = html.replace(/<main id="main">[\s\S]*<\/main>/,
      `<main id="main">\n  <span id="top"></span>\n\n${body}\n</main>`);
    html = html.replace(/\n<link rel="preload" as="image" href="assets\/icon-512\.webp">/, '');
